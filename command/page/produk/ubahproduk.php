...
<form method="post" enctype="multipart/form-data">
	...
	<button class="btn btn-primary" name="rubah">Rubah Data</button>
</form>
...
if (isset($_POST['rubah']))
{
	...
	{
		move_uploaded_file($lokasi_foto, "foto_produk/$namafoto");
		
		$koneksi -> query("UPDATE produk SET nama_produk = '$_POST[nama_produk]',
			harga_produk = '$_POST[harga_produk]', berat = '$_POST[berat]', foto_produk = '$_POST[namafoto]',
			deskripsi_produk = '$_POST[deskripsi_produk]', id_kategori = $_POST[id_kategori] WHERE id_produk = '$_GET[id]' ");
	}
	else
	{
		$koneksi -> query("UPDATE produk SET nama_produk = '$_POST[nama_produk]',
			harga_produk = '$_POST[harga_produk]', berat = '$_POST[berat]',deskripsi_produk = '$_POST[deskripsi_produk]', id_kategori = $_POST[id_kategori] WHERE id_produk = '$_GET[id]' ");
	}
